			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="nuevoTicket.php" method="POST">
							<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><?php echo $sesion; ?></span>
								</div>
							  </div>
							  ...
							  <div class="control-group">
							   ...
							   <div class="control-group">
								<label class="control-label" for="selectError3">Contingencia</label>
								<div class="controls">
								  <select id="Select1" onchange="visible(this.value)" style=" width:250px">
									 <option value="1">No enciende la computadora</option>
              						 <option value="2">Se calienta mucho el equipo</option>
              						 <option value="3">No tengo acceso a la red</option>
             					 	 <option value="4">Tengo problemas con una impresora/periferico</option>
             					     <option value="5">otros...</option>
								  </select>
								  <div class="controls" align="justify">
